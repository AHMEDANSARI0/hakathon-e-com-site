...
export default function Navbar() {
  ...
  return (
    <header className="bg-white shadow-md py-6 px-6 md:px-8">
      <div className="flex justify-around items-center">
        {/* Logo */}
        <div className="flex items-center">
          <img className="h-8" src="/aurenex.svg" alt="Logo" />
        </div>
        ...
        <nav
          ...
          } absolute md:static top-16 left-0 w-full md:w-auto bg-white md:flex items-center`}
        >
